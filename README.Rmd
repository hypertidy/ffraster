...
[![Travis-CI Build Status](https://travis-ci.org/hypertidy/ffraster.svg?branch=master)](https://travis-ci.org/hypertidy/ffraster)
...
[![Coverage Status](https://img.shields.io/codecov/c/github/hypertidy/ffraster/master.svg)](https://codecov.io/github/hypertidy/ffraster?branch=master)
...
ffraster allows loading a file-backed raster as an `ff` object, and some wrappers to deal with the [rasterfile format](https://cran.r-project.org/web/packages/raster/vignettes/rasterfile.pdf) using ff's array abstractions linked to a file on disk.  
...
* a multilayer rasterfile can only be created from an existing multi-layer raster
* setting the values of a rasterfile for a given layer reads all the data into memory and cuts the link to the rasterfile
